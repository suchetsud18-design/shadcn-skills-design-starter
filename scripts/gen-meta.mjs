...
const M = {
  ...
  "aspect-ratio": {
    ...
    note: "Layout-only wrapper — no interactive behaviour. Give media an alt attribute.",
  },
  avatar: {
    figma: "72-2717",
  ...
  checkbox: {
    ...
    note: "Pair with a Label via htmlFor.",
  },
  collapsible: {
    figma: "72-2724",
  ...
  "native-select": {
    ...
    note: "Styled wrapper over the native <select> — best for long/mobile lists.",
  },
  "navigation-menu": {
    figma: "73-1980",
  ...
  "radio-group": {
    ...
    a11y: A_RADIO,
    note: "Arrow keys move and select within the group; only one item is checked.",
  },
  "scroll-area": {
    figma: "73-1985",
  ...
  switch: {
    ...
    a11y: A_TOGGLE,
    note: "Toggles immediately (no submit). Pair with a Label.",
  },
  table: {
    figma: "73-2898",
    imp: `import {\n  Table,\n  TableBody,\n  TableCell,\n  TableHead,\n  TableHeader,\n  TableRow,\n} from "@/components/ui/table"`,
