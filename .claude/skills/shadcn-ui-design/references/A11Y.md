...
The testable companion to the a11y rules in `SKILL.md` §6. Organized by the four POUR principles.
Each criterion includes its WCAG level (A, AA, AAA), priority tier, and testing guidance. This
project targets **AA** (P0 + P1); AAA items are aspirational.
